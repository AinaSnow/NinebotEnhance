...
public record BmsState(int phase,BmsData data,String detail){
    public static final int UNBOUND=0,DENIED=1,CONNECTING=2,HANDSHAKE=3,READY=4,FAILED=5;
    ...
    public String describe(){
        String name=switch(phase){
            case UNBOUND->"未绑定";case DENIED->"无蓝牙权限";case CONNECTING->"连接中";case HANDSHAKE->"握手中";case READY->"已连接";default->"连接失败";
        };
