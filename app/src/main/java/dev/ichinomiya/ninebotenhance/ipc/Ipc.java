...
public final class Ipc {
    ...
    public static void settings(Bundle data, DisplaySettings settings) {
        ...
        data.putInt("keep_phone_dpi",settings.keepPhoneDpi?1:0);data.putInt("compat_scale",settings.compatScale?1:0);data.putInt("light_background_color",settings.lightBackgroundColor);
    }
